...
public class AdvancedWebView extends WebView  {
	...
	protected static final String LANGUAGE_DEFAULT_ISO3 = "fr";
	protected static final String CHARSET_DEFAULT = "UTF-8";
	/** Alternative browsers that have their own rendering engine and *may* be installed on this device */
	protected static final String[] ALTERNATIVE_BROWSERS = new String[] { "org.mozilla.firefox", "com.android.chrome", "com.opera.browser", "org.mozilla.firefox_beta", "com.chrome.beta", "com.opera.browser.beta","org.mozilla.fennec_aurora" };
	 ...
	 */
	public void loadHtml(final String html5) {
		loadHtml(html5, null);
	}
	 ...
	 */
	public void loadHtml(final String html5, final String baseUrl) {
		loadHtml(html5, baseUrl, null);
	}
	 ...
	 */
	public void loadHtml(final String html5, final String baseUrl, final String historyUrl) {
		loadHtml(html5, baseUrl, historyUrl, "utf-8");
	}
	 ...
	 */
	public void loadHtml(final String html5, final String baseUrl, final String historyUrl, final String encoding) {
		loadDataWithBaseURL(baseUrl, html5, "text/html", encoding, historyUrl);
	}
	...
	public static boolean isFileUploadAvailable() {
		return isFileUploadAvailable(true);
	}
	...
	public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
		if (Build.VERSION.SDK_INT < 9) {
			throw new RuntimeException("cela requiet l'api 9");
		}
